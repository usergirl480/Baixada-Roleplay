			...
			if not getPackage then
				...
				if distance <= 3 then
					...
					if initStage then
						...
						if IsControlJustPressed(1,38) and distance <= 1 and inSeconds <= 0 then
							deliveryLocates = math.random(#deliveryCoords)
							TriggerEvent("Notify","importante","Dirija-se até seu caminhão <b>Packer</b> e buzine o mesmo<br>e receba a carga responsável pelo transporte.")
