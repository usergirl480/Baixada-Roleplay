				...
				if distance <= 15 then
					...
					if distance <= 0.5 and IsControlJustPressed(1,38) and vSERVER.enterService() then
						if inService then
							...
							TriggerEvent("NotifyPush",{ code = "QTH", title = "Registro de Veículo", x = vehRescue[serviceLocate][spawnCoords][1], y = vehRescue[serviceLocate][spawnCoords][2], z = vehRescue[serviceLocate][spawnCoords][3], name = "Aguardando reboque.", blipColor = 77 })
						end
					end
				end
			end
