...
local works = {
	...
	["Aztecas"] = {
		...
		["collectCoords"] = {
			{ 746.8,-1399.31,26.62 },
			{ 1165.19,-1347.21,36.18 },
			{ 1144.58,-1008.52,44.92 },
			{ 1218.14,-416.5,67.79 },
			{ 1044.18,190.28,81.0 },
			{ 1196.01,1819.68,78.94 },
			{ 803.03,2174.79,53.06 },
			{ 201.62,2462.44,55.91 },
			{ 346.8,3405.47,36.85 },
			{ 910.96,3644.88,32.67 },
			{ 1412.96,3663.92,34.41 },
			{ 1655.06,3820.45,35.45 },
			{ 1888.34,3893.36,33.51 },
			{ 1632.56,3719.4,35.05 },
			{ 1907.0,3710.4,32.74 },
			{ 2418.51,4020.61,36.83 },
			{ 1968.26,4623.33,41.08 },
			{ 1710.43,4728.52,42.14 },
			{ 1673.12,4957.94,42.34 },
			{ 1961.07,5184.85,47.94 },
			{ 2016.89,4987.79,42.09 },
			{ 2564.56,4680.19,34.07 },
			{ 2697.75,4324.49,46.0 },
			{ 1680.97,6428.59,32.17 },
			{ 56.67,6646.45,32.27 },
			{ -290.51,6387.24,30.68 },
			{ -300.71,6256.71,31.49 },
			{ -20.63,6490.44,31.49 },
			{ 6.39,6414.4,31.42 },
			{ -215.45,6219.34,31.49 },
			{ -378.39,6035.45,31.53 },
			{ -399.99,6377.7,14.04 },
			{ -182.47,6551.04,11.09 },
			{ -2202.97,4244.67,48.34 },
			{ -1123.46,2682.64,18.75 },
			{ -1123.46,2682.64,18.75 },
			{ -310.02,2794.22,59.46 },
			{ -127.7,1921.46,197.31 },
			{ 252.12,358.69,105.95 },
			{ 378.44,106.24,102.78 },
			{ 814.12,-93.32,80.59 },
			{ 1094.72,-265.62,69.3 },
			{ 1138.98,-962.61,47.53 },
			{ 1297.15,-1618.04,54.58 },
			{ 1366.41,-1833.66,57.91 },
			{ 1043.56,-2158.02,31.61 },
			{ 1020.73,-2434.54,29.66 },
			{ 860.43,-2273.41,30.55 },
			{ 913.73,-2154.09,30.5 },
			{ 807.59,-2002.56,29.96 },
			{ 863.7,-1585.55,31.58 }
		},
		["deliveryItem"] = {
			"drugsfragment"
	...
	-- ["Favela01"] = {
	-- 	["coords"] = { -1182.73,-1786.25,4.38,306.15 },
	-- 	["upgradeStress"] = 2,
	-- 	["routeCollect"] = true,
	-- 	["routeDelivery"] = false,
	-- 	["usingVehicle"] = false,
	...
	-- },
	-- ["Favela02"] = {
	-- 	["coords"] = { -2559.24,2309.27,33.21,87.88 },
	-- 	["upgradeStress"] = 2,
	-- 	["routeCollect"] = true,
	-- 	["routeDelivery"] = false,
	-- 	["usingVehicle"] = false,
...
function cRP.collectConsume(serviceName)
	...
	if user_id then
		if works[serviceName]["collectRandom"] then
			...
			-- 	TriggerClientEvent("Notify",source,"default","Você recebeu <b>+"..reputationValue.."</b> de Reputação como Transporte de Valores.",10000,"bottom","atenção")
			-- 	vRP.insertReputation(user_id,"values",reputationValue)
			-- end
...
function cRP.checkPermission(serviceName)
	...
	if user_id then
		...
		--- REVER COMO VAI FUNCIONAR
		if exports["common"]:Group().hasPermission(user_id,works[serviceName]["perm"]) then
			if activeWorks[serviceName] then
				if parseInt(#activeWorks[serviceName]) < 15 then
...
-- 	if activeWorks["Bloods"][user_id] then
-- 		activeWorks["Bloods"][user_id] = nil
-- 	end
	
-- 	if activeWorks["Crips"][user_id] then
-- 		activeWorks["Crips"][user_id] = nil
-- 	end
...
-- 	if activeWorks["Favela05"][user_id] then
-- 		activeWorks["Favela05"][user_id] = nil
-- 	end
	
-- 	if activeWorks["Favela06"][user_id] then
-- 		activeWorks["Favela06"][user_id] = nil
-- 	end
