...
local shopList = {
	...
	{ -172.43,6381.05,31.48,"pharmacyStore",true,false },
	...
	{ 2742.81,3488.54,55.25,"mechanicTools",false,false },
	{ 2718.31,3505.06,55.25,"mechanicTools",false,false },
	{ 2710.26,3508.32,55.25,"mechanicTools",false,false },
...
Citizen.CreateThread(function()
    local innerTable = {}
    for k,v in pairs(shopList) do
        table.insert(innerTable,{ v[1],v[2],v[3],2,"E","Loja","Pressione para abrir" })
    end
