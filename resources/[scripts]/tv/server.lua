...
function src.checkPermission()
    ...
    return exports["store"]:Buyers().isBuyerById(user_id,"tv")
end
...
function src.checkPermission()
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if exports["store"]:Buyers().isBuyerById(user_id,"tv") or exports["common"]:Group().hasPermission(user_id,"staff") then
			return true
		end
	end
end