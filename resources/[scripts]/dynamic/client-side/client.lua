...
RegisterCommand("globalFunctions",function(source,args)
	if not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not menuOpen then
		...
		if GetEntityHealth(ped) > 101 then
			...
			exports["dynamic"]:AddButton("Reputação","Verifique a sua reputação.","reputation_modules:openRep","","others",true)
...
RegisterCommand("adminFunctions",function(source,args)
	if vSERVER.checkPermission() and not menuOpen then
		...
		if GetEntityHealth(ped) > 101 then
			...
			exports["dynamic"]:AddButton("Dominação","Ativar/Desativar.","common:admin_blips:updateConfig","SpecialMode","blips")
			...
			exports["dynamic"]:AddButton("Usuários","Usuários em quarentena.","admin:quarentineList","","quarentine",true)
			exports["dynamic"]:AddButton("Status","Status da quarentena.","admin:quarentineStatus","","quarentine",true)
			exports["dynamic"]:AddButton("Verificar","Verificar usuário.","admin:quarentineCheck","","quarentine",true)
			exports["dynamic"]:AddButton("Adicionar","Adicionar usuário.","admin:quarentineAdd","","quarentine",true)
			exports["dynamic"]:AddButton("Remover","Remover usuário.","admin:quarentineRemove","","quarentine",true)
			exports["dynamic"]:SubMenu("Quarentena","Gerenciamento de quarentena.","quarentine")
			
			exports["dynamic"]:AddButton("Adicionar","Adicionar reputação em squad.","reputation:Add","","reputation",true)
			exports["dynamic"]:AddButton("Remover","Remover reputação de squad.","reputation:Remove","","reputation",true)
			exports["dynamic"]:AddButton("Resetar","Resetar reputação de squad.","reputation:Reset","","reputation",true)
			exports["dynamic"]:SubMenu("Reputação","Gerenciamento de reputação.","reputation")
			...
			exports["dynamic"]:AddButton("Renomear","Renomear usuário.","admin:renameUsers","","users",true)
			...
			exports["dynamic"]:SubMenu("Usuário","Gerenciamento de usuários.","users")

			exports["dynamic"]:AddButton("Adicionar","Adicionar veículos.","admin:addCars","","cars",true)
			exports["dynamic"]:AddButton("Remover","Remover veículos.","admin:removeCars","","cars",true)
			exports["dynamic"]:AddButton("Verificar","Verificar veículos.","admin:checkCars","","cars",true)
			exports["dynamic"]:SubMenu("Veículo","Gerenciamento de veículos.","cars")

			exports["dynamic"]:AddButton("Adicionar","Adicionar cryptos ao usuário.","admin:addCryptos","","cryptos",true)
			exports["dynamic"]:AddButton("Remover","Remover cryptos do usuário.","admin:removeCryptos","","cryptos",true)
			exports["dynamic"]:AddButton("Verificar","Verificar cryptos do usuário.","admin:checkCryptos","","cryptos",true)
			exports["dynamic"]:SubMenu("Crypto","Gerenciamento de cryptos.","cryptos")

			exports["dynamic"]:AddButton("Adicionar","Adicionar usuário no squad.","squads:userSquad","","squad",true)
			...
			exports["dynamic"]:AddButton("Garagem","Adicionar benefício.","admin:setGaragesVips","","vip",true)
			exports["dynamic"]:AddButton("Carro","Adicionar benefício.","admin:setCarVips","","vip",true)
			exports["dynamic"]:AddButton("Casa","Adicionar benefício.","admin:setHouseVips","","vip",true)
			...
			exports["dynamic"]:AddButton("Criar","Criar baú.","admin:newChest","","chest",true)
			exports["dynamic"]:AddButton("Deletar","Deletar baú.","admin:deleteChest","","chest",true)
			exports["dynamic"]:AddButton("Resetar","Resetar baú.","admin:resetChest","","chest",true)
			exports["dynamic"]:AddButton("Listar","Listar baú.","admin:listChest","","chest",true)
			exports["dynamic"]:SubMenu("Baú","Gerenciamento de baú.","chest")
    ...
    if not exports["player"]:blockCommands() and not exports["player"]:handCuff() and not menuOpen then
		...
		if GetEntityHealth(ped) > 101 then
			...
			if permitted and leader then
				...
				exports["dynamic"]:SubMenu("Opções","Gerenciamento de uniformes.","optionsUniforms")
